  ...
  const handleCheckout = async () => {
    try {
      ...
      try {
        ...
        const {data:orderData} = await axios.post('https://spare-sphere-1.onrender.com/payment/process', {
          totalPrice
        });
        const {key} = keyData;
        ...
        const options = {
          ...
          callback_url: 'https://spare-sphere-1.onrender.com/paymentSuccess', // Your success URL
          prefill: {
            name: 'Gaurav Kumar',

        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/about" className="text-gray-400 hover:text-orange-500 transition duration-300">
                  About Us
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/privacy-policy" className="text-gray-400 hover:text-orange-500 transition duration-300">
                  Privacy Policy
                </a>
              </li>
              <li>

...
const About = () => {
  return (
    <div className="p-8 bg-gray-900 text-white min-h-screen">
      ...
      <motion.div 
        className="relative overflow-hidden rounded-lg shadow-lg mb-10"
      ...
      {/* Introductory Text */}
      <motion.p 
        className="text-gray-300 text-lg leading-relaxed mb-6 text-center"
      ...
      {/* Closing Statement */}
      <motion.p 
        className="text-gray-300 text-lg leading-relaxed mt-6 mb-12 text-center"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-orange-500 mb-2">Quality Products</h2>
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-orange-500 mb-2">Outstanding Service</h2>
          <p className="text-gray-300 text-lg leading-relaxed px-4">
            We are dedicated to delivering exceptional customer service, ensuring a seamless shopping experience
            for all your automotive needs.
          </p>
